            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="{{url('admin/child-category/destroy')}}" method="post" >
                            @csrf
                            @method('DELETE')
                                @can('xoa danh muc con')
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Tình trạng</th>
                                            <th>Danh mục</th>
                                            @can('cap nhat danh muc con')
                                            <th>Cập nhật</th>
                                            @endcan
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach($childcate as $row)
                                        <tr>
                                            ...
                                            @can('cap nhat danh muc con')
                                            <td>
                                                <a href="{{url('admin/child-category')}}/{{$row->id}}/edit" class="btn btn-warning">Cập nhật</a>
                                            </td>
                                            @endcan
                                        </tr>
                                        @endforeach
