            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="{{url('admin/category_blog/destroy')}}" method="post" >
                            @csrf
                            @method('DELETE')
                                @can('xoa danh muc bai viet')
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>ID</th>
                                            <th>Tên</th>
                                            @can('cap nhat danh muc bai viet')
                                            <th>Cập nhật</th>
                                            @endcan 
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$row->name}}</td>
                                            @can('cap nhat danh muc bai viet')
                                            <td><a href="{{url('admin/category_blog')}}/{{$row->id}}/edit" class="btn btn-warning">Cập nhật</a></td>  
                                            @endcan 
                                        </tr>
                                        @endforeach
                                    </tbody>
