...
@section('title','Cập nhật Slide Banner')
<style>
    .hidden {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-12 col-md-12">
                                                <select name="slide_status" id="select" class="form-control">
                                                    ...
                                                    <option @if ($data->slide_status==0) selected @endif value="0">Ẩn </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class=" form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <div class="col col-md-6">
                                                <label for="file-input" class=" form-control-label">Ảnh banner</label>
                                            </div>
                                            <div class="col-12 col-md-12">
